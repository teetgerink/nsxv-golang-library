...
type Class20SiApiService service
/*
Class20SiApiService agentInformationRead
Retrieve agent (host components and appliances) details.   Parameters:  agentID: Specified agent  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param agentID

*/
func (a *Class20SiApiService) Api20SiAgentAgentIDGet(ctx context.Context, agentID string) (*http.Response, error) {
	var (
...
/*
Class20SiApiService deploymentAgentsRead
Retrieve all agents for the specified deployment.  Parameters:  deploymentunitID: Specified deployment.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param deploymentunitID

*/
func (a *Class20SiApiService) Api20SiDeploymentDeploymentunitIDAgentsGet(ctx context.Context, deploymentunitID string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SiApiService agentConflictsRead
Retrieve conflicting deployment units and EAM agencies, if any, and the allowed operations on them.   Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

*/
func (a *Class20SiApiService) Api20SiFabricSyncConflictsGet(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SiApiService agentConflictsUpdate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class20SiApiApi20SiFabricSyncConflictsPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20SiApiApi20SiFabricSyncConflictsPutOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20SiApiService) Api20SiFabricSyncConflictsPut(ctx context.Context, localVarOptionals *Class20SiApiApi20SiFabricSyncConflictsPutOpts) (*http.Response, error) {
	var (
...
/*
Class20SiApiService hostAgentsRead
...
*/
func (a *Class20SiApiService) Api20SiHostHostIDAgentsGet(ctx context.Context, hostID string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
