...
type Class20AlarmsApiService service
/*
Class20AlarmsApiService servicesAlarmsSourceList
...
*/
func (a *Class20AlarmsApiService) Api20ServicesAlarmsSourceIdGet(ctx context.Context, sourceId string) (*http.Response, error) {
	var (
...
/*
Class20AlarmsApiService servicesAlarmsSourceUpdate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sourceId
 * @param optional nil or *Class20AlarmsApiApi20ServicesAlarmsSourceIdPostOpts - Optional Parameters:
...
type Class20AlarmsApiApi20ServicesAlarmsSourceIdPostOpts struct {
    Body optional.Interface
    ContentType optional.String
    Action optional.String
}

func (a *Class20AlarmsApiService) Api20ServicesAlarmsSourceIdPost(ctx context.Context, sourceId string, localVarOptionals *Class20AlarmsApiApi20ServicesAlarmsSourceIdPostOpts) (*http.Response, error) {
	var (
