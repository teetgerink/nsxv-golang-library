...
type Class21FlowApiService service
/*
Class21FlowApiService flowConfigRead
Retrieve flow monitoring configuration.  Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

*/
func (a *Class21FlowApiService) Api21AppFlowConfigGet(ctx context.Context) (*http.Response, error) {
	var (
...
/*
Class21FlowApiService flowsConfigCreate
Update flow monitoring configuration.  Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class21FlowApiApi21AppFlowConfigPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class21FlowApiApi21AppFlowConfigPutOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class21FlowApiService) Api21AppFlowConfigPut(ctx context.Context, localVarOptionals *Class21FlowApiApi21AppFlowConfigPutOpts) (*http.Response, error) {
	var (
...
/*
Class21FlowApiService flowContextDelete
Delete flow records for the specified context.  Parameters:  contextId: Context ID.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contextId

*/
func (a *Class21FlowApiService) Api21AppFlowContextIdDelete(ctx context.Context, contextId string) (*http.Response, error) {
	var (
...
/*
Class21FlowApiService flowStatsRead
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class21FlowApiApi21AppFlowFlowstatsGetOpts - Optional Parameters:
...
type Class21FlowApiApi21AppFlowFlowstatsGetOpts struct {
...
func (a *Class21FlowApiService) Api21AppFlowFlowstatsGet(ctx context.Context, localVarOptionals *Class21FlowApiApi21AppFlowFlowstatsGetOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class21FlowApiService flowStatsInfoRead
...
*/
func (a *Class21FlowApiService) Api21AppFlowFlowstatsInfoGet(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
