...
type Class10CliApiService service
/*
Class10CliApiService nsxCliExecute
 ...
 * @param optional nil or *Class10CliApiApi10NsxCliPostOpts - Optional Parameters:
...
type Class10CliApiApi10NsxCliPostOpts struct {
...
func (a *Class10CliApiService) Api10NsxCliPost(ctx context.Context, localVarOptionals *Class10CliApiApi10NsxCliPostOpts) (*http.Response, error) {
	var (
