...
type Class20NwfabricApiService service
/*
Class20NwfabricApiService nwfabricClustersDelete
Delete locale ID for the specified cluster.  Parameters:  clusterID: Cluster ID.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterID

*/
func (a *Class20NwfabricApiService) Api20NwfabricClustersClusterIDDelete(ctx context.Context, clusterID string) (*http.Response, error) {
	var (
...
/*
Class20NwfabricApiService nwfabricClustersRead
Retrieve the locale ID for the specified cluster.  Parameters:  clusterID: Cluster ID.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterID

*/
func (a *Class20NwfabricApiService) Api20NwfabricClustersClusterIDGet(ctx context.Context, clusterID string) (*http.Response, error) {
	var (
...
/*
Class20NwfabricApiService nwfabricClustersUpdate
Update the locale ID for the specified cluster.  Parameters:  clusterID: Cluster ID.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterID
 * @param optional nil or *Class20NwfabricApiApi20NwfabricClustersClusterIDPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20NwfabricApiApi20NwfabricClustersClusterIDPutOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20NwfabricApiService) Api20NwfabricClustersClusterIDPut(ctx context.Context, clusterID string, localVarOptionals *Class20NwfabricApiApi20NwfabricClustersClusterIDPutOpts) (*http.Response, error) {
	var (
...
/*
Class20NwfabricApiService nwfabricConfigDelete
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class20NwfabricApiApi20NwfabricConfigureDeleteOpts - Optional Parameters:
     * @param "ContentType" (optional.String) - 

*/

type Class20NwfabricApiApi20NwfabricConfigureDeleteOpts struct {
    ContentType optional.String
}

func (a *Class20NwfabricApiService) Api20NwfabricConfigureDelete(ctx context.Context, localVarOptionals *Class20NwfabricApiApi20NwfabricConfigureDeleteOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20NwfabricApiService nwfabricConfigCreate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class20NwfabricApiApi20NwfabricConfigurePostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 
...
type Class20NwfabricApiApi20NwfabricConfigurePostOpts struct {
    Body optional.Interface
    ContentType optional.String
    Action optional.String
}

func (a *Class20NwfabricApiService) Api20NwfabricConfigurePost(ctx context.Context, localVarOptionals *Class20NwfabricApiApi20NwfabricConfigurePostOpts) (*http.Response, error) {
	var (
...
/*
Class20NwfabricApiService nwfabricConfigUpdate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class20NwfabricApiApi20NwfabricConfigurePutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20NwfabricApiApi20NwfabricConfigurePutOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20NwfabricApiService) Api20NwfabricConfigurePut(ctx context.Context, localVarOptionals *Class20NwfabricApiApi20NwfabricConfigurePutOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20NwfabricApiService nwfabricFeaturesList
Retrieves all network fabric features available on the cluster. Multiple **featureInfo** sections may be returned.   Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

*/
func (a *Class20NwfabricApiService) Api20NwfabricFeaturesGet(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20NwfabricApiService nwfabricHostsDelete
Delete the locale ID for the specified host.  Parameters:  hostID: Host ID.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hostID

*/
func (a *Class20NwfabricApiService) Api20NwfabricHostsHostIDDelete(ctx context.Context, hostID string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20NwfabricApiService nwfabricHostsRead
Retrieve the locale ID for the specified host.  Parameters:  hostID: Host ID.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hostID

*/
func (a *Class20NwfabricApiService) Api20NwfabricHostsHostIDGet(ctx context.Context, hostID string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20NwfabricApiService nwfabricHostsUpdate
Update the locale ID for the specified host.  Parameters:  hostID: Host ID.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hostID
 * @param optional nil or *Class20NwfabricApiApi20NwfabricHostsHostIDPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20NwfabricApiApi20NwfabricHostsHostIDPutOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20NwfabricApiService) Api20NwfabricHostsHostIDPut(ctx context.Context, hostID string, localVarOptionals *Class20NwfabricApiApi20NwfabricHostsHostIDPutOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20NwfabricApiService statusResourceTypeRead
Retrieve status of resources by criterion.   Parameters:  resourceType: Valid resource type  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param resourceType

*/
func (a *Class20NwfabricApiService) Api20NwfabricStatusAlleligibleResourceTypeGet(ctx context.Context, resourceType string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20NwfabricApiService childStatusRead
...
*/
func (a *Class20NwfabricApiService) Api20NwfabricStatusChildParentResourceIDGet(ctx context.Context, parentResourceID string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20NwfabricApiService nwfabricStatusRead
Retrieve the network fabric status of the specified resource.   Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class20NwfabricApiApi20NwfabricStatusGetOpts - Optional Parameters:
     * @param "Resource" (optional.String) - 

*/

type Class20NwfabricApiApi20NwfabricStatusGetOpts struct {
    Resource optional.String
}

func (a *Class20NwfabricApiService) Api20NwfabricStatusGet(ctx context.Context, localVarOptionals *Class20NwfabricApiApi20NwfabricStatusGetOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
