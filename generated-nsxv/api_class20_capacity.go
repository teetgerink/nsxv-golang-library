...
type Class20CapacityApiService service
/*
Class20CapacityApiService capacityUsageRead
...
*/
func (a *Class20CapacityApiService) Api20ServicesLicensingCapacityusageGet(ctx context.Context) (*http.Response, error) {
	var (
