...
type Class20SecuritytagsApiService service
/*
Class20SecuritytagsApiService securitytagsCriteriaRead
...
*/
func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsSelectionCriteriaGet(ctx context.Context) (*http.Response, error) {
	var (
...
/*
Class20SecuritytagsApiService securitytagsCriteriaUpdate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class20SecuritytagsApiApi20ServicesSecuritytagsSelectionCriteriaPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20SecuritytagsApiApi20ServicesSecuritytagsSelectionCriteriaPutOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsSelectionCriteriaPut(ctx context.Context, localVarOptionals *Class20SecuritytagsApiApi20ServicesSecuritytagsSelectionCriteriaPutOpts) (*http.Response, error) {
	var (
...
/*
Class20SecuritytagsApiService securityTagRead
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class20SecuritytagsApiApi20ServicesSecuritytagsTagGetOpts - Optional Parameters:
     * @param "IsUniversal" (optional.String) - 

*/

type Class20SecuritytagsApiApi20ServicesSecuritytagsTagGetOpts struct {
    IsUniversal optional.String
}

func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsTagGet(ctx context.Context, localVarOptionals *Class20SecuritytagsApiApi20ServicesSecuritytagsTagGetOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritytagsApiService securityTagCreate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Class20SecuritytagsApiApi20ServicesSecuritytagsTagPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20SecuritytagsApiApi20ServicesSecuritytagsTagPostOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsTagPost(ctx context.Context, localVarOptionals *Class20SecuritytagsApiApi20ServicesSecuritytagsTagPostOpts) (*http.Response, error) {
	var (
...
/*
Class20SecuritytagsApiService securityTagDeleteDelete
Delete the specified security tag.  Parameters:  tagId: Specified security tag.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tagId

*/
func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsTagTagIdDelete(ctx context.Context, tagId string) (*http.Response, error) {
	var (
...
/*
Class20SecuritytagsApiService securityTagVMDetailList
...
*/
func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsTagTagIdVmDetailGet(ctx context.Context, tagId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritytagsApiService securityTagVMsListList
Retrieve the list of VMs that have the specified tag attached to them.   Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tagId

*/
func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsTagTagIdVmGet(ctx context.Context, tagId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritytagsApiService securityTagVMsAction
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tagId
 * @param optional nil or *Class20SecuritytagsApiApi20ServicesSecuritytagsTagTagIdVmPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 
...
type Class20SecuritytagsApiApi20ServicesSecuritytagsTagTagIdVmPostOpts struct {
    Body optional.Interface
    ContentType optional.String
    Action optional.String
}

func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsTagTagIdVmPost(ctx context.Context, tagId string, localVarOptionals *Class20SecuritytagsApiApi20ServicesSecuritytagsTagTagIdVmPostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritytagsApiService securityTagVMDetach
...
*/
func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsTagTagIdVmVmIdDelete(ctx context.Context, tagId string, vmId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritytagsApiService securityTagVMAttach
...
*/
func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsTagTagIdVmVmIdPut(ctx context.Context, tagId string, vmId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritytagsApiService securitytagVmIdList
...
*/
func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsVmVmIdGet(ctx context.Context, vmId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritytagsApiService securitytagVmMoidAction
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param vmId
 * @param optional nil or *Class20SecuritytagsApiApi20ServicesSecuritytagsVmVmIdPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 
     * @param "Action" (optional.String) - 
...
type Class20SecuritytagsApiApi20ServicesSecuritytagsVmVmIdPostOpts struct {
    Body optional.Interface
    ContentType optional.String
    Action optional.String
}

func (a *Class20SecuritytagsApiService) Api20ServicesSecuritytagsVmVmIdPost(ctx context.Context, vmId string, localVarOptionals *Class20SecuritytagsApiApi20ServicesSecuritytagsVmVmIdPostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
