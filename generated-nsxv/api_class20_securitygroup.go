...
type Class20SecuritygroupApiService service
/*
Class20SecuritygroupApiService secGroupBulkObjectUpdate
 ...
 * @param objectId
 * @param optional nil or *Class20SecuritygroupApiApi20ServicesSecuritygroupBulkObjectIdPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20SecuritygroupApiApi20ServicesSecuritygroupBulkObjectIdPutOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupBulkObjectIdPut(ctx context.Context, objectId string, localVarOptionals *Class20SecuritygroupApiApi20ServicesSecuritygroupBulkObjectIdPutOpts) (*http.Response, error) {
	var (
...
/*
Class20SecuritygroupApiService secGroupBulkCreate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param scopeId
 * @param optional nil or *Class20SecuritygroupApiApi20ServicesSecuritygroupBulkScopeIdPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20SecuritygroupApiApi20ServicesSecuritygroupBulkScopeIdPostOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupBulkScopeIdPost(ctx context.Context, scopeId string, localVarOptionals *Class20SecuritygroupApiApi20ServicesSecuritygroupBulkScopeIdPostOpts) (*http.Response, error) {
	var (
...
/*
Class20SecuritygroupApiService secGroupInternalRead
...
*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupInternalScopeScopeIdGet(ctx context.Context, scopeId string) (*http.Response, error) {
	var (
...
/*
Class20SecuritygroupApiService secGroupLookupVMRead
...
*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupLookupVirtualmachineVirtualMachineIdGet(ctx context.Context, virtualMachineId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupObjectDelete
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param objectId
 * @param optional nil or *Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdDeleteOpts - Optional Parameters:
     * @param "Force" (optional.String) - 

*/

type Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdDeleteOpts struct {
    Force optional.String
}

func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupObjectIdDelete(ctx context.Context, objectId string, localVarOptionals *Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdDeleteOpts) (*http.Response, error) {
	var (
...
/*
Class20SecuritygroupApiService secGroupObjectRead
Retrieve all members of the specified security group.  Parameters:  objectId: Security group ID.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param objectId

*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupObjectIdGet(ctx context.Context, objectId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupMemberDelete
 ...
 * @param objectId
 * @param memberId
 * @param optional nil or *Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdMembersMemberIdDeleteOpts - Optional Parameters:
     * @param "FailIfAbsent" (optional.String) - 

*/

type Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdMembersMemberIdDeleteOpts struct {
    FailIfAbsent optional.String
}

func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupObjectIdMembersMemberIdDelete(ctx context.Context, objectId string, memberId string, localVarOptionals *Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdMembersMemberIdDeleteOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupMemberUpdate
 ...
 * @param objectId
 * @param memberId
 * @param optional nil or *Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdMembersMemberIdPutOpts - Optional Parameters:
     * @param "FailIfExists" (optional.String) - 

*/

type Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdMembersMemberIdPutOpts struct {
    FailIfExists optional.String
}

func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupObjectIdMembersMemberIdPut(ctx context.Context, objectId string, memberId string, localVarOptionals *Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdMembersMemberIdPutOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupObjectUpdate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param objectId
 * @param optional nil or *Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdPutOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupObjectIdPut(ctx context.Context, objectId string, localVarOptionals *Class20SecuritygroupApiApi20ServicesSecuritygroupObjectIdPutOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupIPNodesRead
Retrieve list of IP addresses that belong to a specific security group.   Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param objectId

*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupObjectIdTranslationIpaddressesGet(ctx context.Context, objectId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupMacNodesRead
Retrieve list of MAC addresses that belong to a specific security group.   Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param objectId

*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupObjectIdTranslationMacaddressesGet(ctx context.Context, objectId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupVMNodesRead
Retrieve list of virtual machine entities that belong to a specific security group.   Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param objectId

*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupObjectIdTranslationVirtualmachinesGet(ctx context.Context, objectId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupVnicNodesRead
Retrieve list of vNICs that belong to a specific security group.   Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param objectId

*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupObjectIdTranslationVnicsGet(ctx context.Context, objectId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupScopeIdCreate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param scopeId
 * @param optional nil or *Class20SecuritygroupApiApi20ServicesSecuritygroupScopeIdPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "ContentType" (optional.String) - 

*/

type Class20SecuritygroupApiApi20ServicesSecuritygroupScopeIdPostOpts struct {
    Body optional.Interface
    ContentType optional.String
}

func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupScopeIdPost(ctx context.Context, scopeId string, localVarOptionals *Class20SecuritygroupApiApi20ServicesSecuritygroupScopeIdPostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupScopeRead
...
*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupScopeScopeIdGet(ctx context.Context, scopeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupScopeMembersRead
Retrieve a list of valid elements that can be added to a security group.   Parameters:  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param scopeId

*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupScopeScopeIdMemberTypesGet(ctx context.Context, scopeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Class20SecuritygroupApiService secGroupScopeMemberTypeRead
...
*/
func (a *Class20SecuritygroupApiService) Api20ServicesSecuritygroupScopeScopeIdMembersMemberTypeGet(ctx context.Context, scopeId string, memberType string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
