 ...
 * @param optional nil or *PolicyApiApi20ServicesPolicySecurityactionCategoryVirtualmachinesGetOpts - Optional Parameters:
     * @param "AttributeKey" (optional.String) -
     * @param "AttributeValue" (optional.String) -

*/

type PolicyApiApi20ServicesPolicySecurityactionCategoryVirtualmachinesGetOpts struct {
	AttributeKey   optional.String
	AttributeValue optional.String
}

func (a *PolicyApiService) Api20ServicesPolicySecurityactionCategoryVirtualmachinesGet(ctx context.Context, localVarOptionals *PolicyApiApi20ServicesPolicySecurityactionCategoryVirtualmachinesGetOpts) (*http.Response, error) {
	var (
...
*/
func (a *PolicyApiService) Api20ServicesPolicySecuritygroupIDSecurityactionsGet(ctx context.Context, iD string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *PolicyApiService) Api20ServicesPolicySecuritygroupIDSecuritypoliciesGet(ctx context.Context, iD string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyAlarmsAllGet(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicyApiApi20ServicesPolicySecuritypolicyHierarchyGetOpts - Optional Parameters:
     * @param "PolicyIds" (optional.String) -
     * @param "Prefix" (optional.String) -

*/

type PolicyApiApi20ServicesPolicySecuritypolicyHierarchyGetOpts struct {
	PolicyIds optional.String
	Prefix    optional.String
}

func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyHierarchyGet(ctx context.Context, localVarOptionals *PolicyApiApi20ServicesPolicySecuritypolicyHierarchyGetOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicyApiApi20ServicesPolicySecuritypolicyHierarchyPostOpts - Optional Parameters:
...
type PolicyApiApi20ServicesPolicySecuritypolicyHierarchyPostOpts struct {
	Body        optional.Interface
	ContentType optional.String
	Suffix      optional.String
}

func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyHierarchyPost(ctx context.Context, localVarOptionals *PolicyApiApi20ServicesPolicySecuritypolicyHierarchyPostOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param iD
 * @param optional nil or *PolicyApiApi20ServicesPolicySecuritypolicyIDDeleteOpts - Optional Parameters:
     * @param "Force" (optional.String) -

*/

type PolicyApiApi20ServicesPolicySecuritypolicyIDDeleteOpts struct {
	Force optional.String
}

func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyIDDelete(ctx context.Context, iD string, localVarOptionals *PolicyApiApi20ServicesPolicySecuritypolicyIDDeleteOpts) (*http.Response, error) {
	var (
...
*/
func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyIDGet(ctx context.Context, iD string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param iD
 * @param optional nil or *PolicyApiApi20ServicesPolicySecuritypolicyIDPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) -
     * @param "ContentType" (optional.String) -

*/

type PolicyApiApi20ServicesPolicySecuritypolicyIDPutOpts struct {
	Body        optional.Interface
	ContentType optional.String
}

func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyIDPut(ctx context.Context, iD string, localVarOptionals *PolicyApiApi20ServicesPolicySecuritypolicyIDPutOpts) (*http.Response, error) {
	var (
...
*/
func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyIDSecurityactionsGet(ctx context.Context, iD string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicyApiApi20ServicesPolicySecuritypolicyPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) -
     * @param "ContentType" (optional.String) -

*/

type PolicyApiApi20ServicesPolicySecuritypolicyPostOpts struct {
	Body        optional.Interface
	ContentType optional.String
}

func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyPost(ctx context.Context, localVarOptionals *PolicyApiApi20ServicesPolicySecuritypolicyPostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyServiceproviderFirewallGet(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicyApiApi20ServicesPolicySecuritypolicyServiceproviderFirewallPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) -
     * @param "ContentType" (optional.String) -

*/

type PolicyApiApi20ServicesPolicySecuritypolicyServiceproviderFirewallPutOpts struct {
	Body        optional.Interface
	ContentType optional.String
}

func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyServiceproviderFirewallPut(ctx context.Context, localVarOptionals *PolicyApiApi20ServicesPolicySecuritypolicyServiceproviderFirewallPutOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *PolicyApiService) Api20ServicesPolicySecuritypolicyStatusGet(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicyApiApi20ServicesPolicyServiceproviderFirewallGetOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -

*/

type PolicyApiApi20ServicesPolicyServiceproviderFirewallGetOpts struct {
	ContentType optional.String
}

func (a *PolicyApiService) Api20ServicesPolicyServiceproviderFirewallGet(ctx context.Context, localVarOptionals *PolicyApiApi20ServicesPolicyServiceproviderFirewallGetOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *PolicyApiService) Api20ServicesPolicyVirtualmachineIDSecurityactionsGet(ctx context.Context, iD string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
