...
func (a *AuditlogApiService) AuditlogGet(ctx context.Context, lOptionals *AuditlogApiAuditlogGetOpts) (*http.Response, error) {
	var (
	...
	lPath := a.client.cfg.BasePath + "/api/2.0/auditlog"
